...
*** Upgrade =logback-core= only
	...
	Refer: [[file:../db/com.github.docker-java/docker-java/ffcd6522da105454391fdf865e1ef9ccd0e4b26c/one/logback-core/runtest.less][runtest.log]]
...
Caused by: java.lang.IllegalStateException: org.slf4j.LoggerFactory in failed state. Original exception was thrown EARLIER. See also http://www.slf4j.org/codes.html#unsuccessfulInit
	 ...
	 Then the reason why =LoggerFactory= initializes unsuccessfully lies in the mismatch versions of =logback-core=

	 =LoggerFactory= is in =org.slf4j.slf4j-api=
** TODO objectify > appengine
   + client: objectify,
     - lib: com.google.appengine:appengine-api-1.0-sdk
     - old version: 1.9.24, new version: 1.9.77
     - type: Fail Only
